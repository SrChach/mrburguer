										...
										<div class="panel-body" id="formularioregistros">
											<form name="formulario" id="formulario" method="POST">
												<div class="row">
													...
													<div class="form-group col-sm-6">
														<label for="idEmpleadoRecibe">ID del Empleado que recibe</label>
														<input class="form-control" type="number" name="idEmpleadoRecibe" id="idEmpleadoRecibe" maxlength="20" required/>
													</div>
													<div class="form-group col-sm-6">
														<label for="cantidadRecibida">Cantidad recibida</label>
														<input class="form-control" type="number" name="cantidadRecibida" id="cantidadRecibida" maxlength="25" required/>
													</div>
													<div class="form-group col-sm-6">
														<label for="observaciones">Observaciones</label>
														<textarea class="form-control" type="number" name="observaciones" id="observaciones" maxlength="25" required></textarea>
													</div>
												</div>
